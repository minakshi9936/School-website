          ...
          {contactInfo.map((info, index) => {
            ...
            return (
              <AnimatedCard key={index} delay={index * 0.1} className="p-6 text-center">
                <div
                  className={`w-14 h-14 rounded-lg bg-gradient-to-br ${info.color} flex items-center justify-center mb-4 mx-auto`}
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <AnimatedCard className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:shadow-xl transition-shadow font-semibold text-lg"
              >
                Send Message
              </button>
            </form>
